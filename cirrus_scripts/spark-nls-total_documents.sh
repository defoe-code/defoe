...
$SPARK_HOME/bin/spark-submit --master spark://$hostmaster:7077 --executor-memory 60g --py-files defoe.zip defoe/run_query.py nls_total.txt nls defoe.nls.queries.total_documents  -r results_total_documents -n $NUMCORES > log.txt 
