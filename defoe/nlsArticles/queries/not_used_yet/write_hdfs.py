...
def do_query(archives, config_file=None, logger=None, context=None):
    ...
    key_header_articles = pages_header_articles.flatMap(
        lambda articles_page: [(articles_page[0], articles_page[1], articles_page[2],\
                               articles_page[3], articles_page[4], articles_page[5], articles_page[6], articles_page[7], \
                               articles_page[8], articles_page[9], articles_page[10], \
                               articles_page[11], articles_page[12], key, articles_page[13][key], articles_page[14],\
                               articles_page[15]) for key in articles_page[13]]) 


    print("ARTICLES: %s" % key_header_articles.collect())
